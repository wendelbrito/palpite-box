    ...
    return (
        <div className='pt-6'>
            ...
            {!sucess && <div className='w-1/5 mx-auto'>
                ...
                <button className='bg-blue-600 px-12 py-4 font-bold rounded-lg shadow-lg hover:shadow' onClick={save}>Salvar</button>
            </div>}
            {sucess && <div className='w-1/5 mx-auto'>
                ...
                {
                    retorno.showCoupon && <div className='text-center text-1xl border p-4 mb-4'>
                        Seu Cupom: <br />
                ...
                }
                {
                    retorno.showCoupon && <div className='text-center border p-4 mb-4'>
                        ...
                        <br />
                        <span className='italic'>Tire um print ou foto desta tela e mostre ao garçon.</span>
                    </div>
                }
            </div>}
        </div>
